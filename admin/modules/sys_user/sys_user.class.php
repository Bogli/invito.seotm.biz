        ...
        ?>
         ...
         <tr>
          ...
          <td>
           ...
           //$params = " onBlur=\"if(document.$formname.email.value!='' AND document.$formname.email.value!=document.$formname.email.value) isLoginAlias('".$url."', 'isalias', 'alias_checkup')\" ";
           $this->Form->TextBox('email', stripslashes($val), 50); ?>&nbsp;<? //$this->Form->ButtonSimple( 'check_alias', $this->Msg_text['_BTN_CHECK_UP'], NULL, "onClick=\"if(document.$formname.email.value!='') isLoginAlias('".$url."&check_up=1', 'isalias', 'alias_checkup')\"" );
           ?>
          </td>
          <td>
           <div id="isalias"></div>
